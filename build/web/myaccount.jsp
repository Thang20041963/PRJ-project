...
display: block;
                                    ...
                                    <c:set value="${requestScope.order}" var="ord"/>   
                                                            ...
                                                            <c:forEach var="order" items="${ord}" >                                                            
                                                                <tr>
                                                                    ...
                                                                    <td><fmt:formatNumber type = "number" 
                                                                              pattern="#,##0"  value = "${order.getTotalPrice()}" /></td>
                                    ...
                                    <h3>Money Request</h3>
                                <c:set value="${requestScope.moneyrequest}" var="mnrq"/>   
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Note</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="money" items="${mnrq}" >                                                            
                                                                <tr>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <form name="f" action="account?action=changeinfor" method="post">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <form name="f" action="account?action=changepass" method="post">
                                        <div class="form-group">
