...
<head>
    <title>Danh sách sản phẩm | Quản trị Admin | KingcapStore</title>
                            ...
                            <tr>
                                 <td>${p.getId()}</td>
                                                ...
                                                <td><fmt:formatNumber type = "number" 
                                                                              pattern="#,##0" value = "${p.getInPrice()}" /></td>
                                                <td><fmt:formatNumber type = "number" 
                                                                              pattern="#,##0" value = "${p.getOutPrice()}" /></td>
                                                <td>
                                                    ${p.getType().getName()}
                                                </td>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control" type="text" name="in_price" required value="<fmt:formatNumber type = "number" 
                                                                              pattern="#,##0" value = "${p.getInPrice()}" />">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Giá Bán</label>
                                                                <input class="form-control" type="text" name="out_price" required value="<fmt:formatNumber type = "number" 
                                                                              pattern="#,##0" value = "${p.getOutPrice()}" />">
                                                            </div>
                                                            <div class="form-group col-md-6">
