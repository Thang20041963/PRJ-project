...
<html lang="en">
	...
	<body>
            <c:set var="bs" value="${requestScope.BSlist}"/>
            <c:set var="l" value="${requestScope.Llist}"/>
            <c:set var="bp" value="${requestScope.BPlist}"/>
				...
				<div class="row">
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							<div>
                                                                ...
                                                                <c:forEach items="${bs}" var="i" begin = "0" end = "2">
                                                                <!-- product widget -->
                                                                <div class="product-widget">
                                                                    <div class="product-img">
							...
							<div>
							<c:forEach items="${bs}" var="i" begin = "3" end = "5">
                                                                <!-- product widget -->
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="product_images/${i.img.get(0)}" width="60px" height="60px" alt="">
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
                                                            <c:forEach items="${l}" var="i" begin = "0" end = "2">
                                                                <!-- product widget -->
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="product_images/${i.img.get(0)}" width="60px" height="60px" alt="">
							...
							<div>
                                                            <c:forEach items="${l}" var="i" begin = "3" end = "5">
                                                                <!-- product widget -->
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="product_images/${i.img.get(0)}" width="60px" height="60px" alt="">
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							<div>
                                                            <c:forEach items="${bp}" var="i" begin = "0" end = "2">
                                                                <!-- product widget -->
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="product_images/${i.img.get(0)}" width="60px" height="60px" alt="">
							...
							<div>
                                                            <c:forEach items="${bp}" var="i" begin = "3" end = "5">
                                                                <!-- product widget -->
                                                                <div class="product-widget">
                                                                    <div class="product-img">
                                                                        <img src="product_images/${i.img.get(0)}" width="60px" height="60px" alt="">
